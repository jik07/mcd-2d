...
while running:
    ...
    player_rect, yChange, xChange, ignore, s, new_level, player_movement, through_door, d = move_player(player_rect, yChange, xChange, ignore, tile_rects, player_movement, s, spawn, new_level, d, through_door)
